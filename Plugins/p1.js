...
Draw.loadPlugin(function(ui) {
	...
	if (ui.sidebar != null)
	{
	    ...
	    ui.sidebar.addPalette('esolia', 'eSolia', true, function(content) {
	        ...
	        content.appendChild(ui.sidebar.createVertexTemplate('text;spacingTop=-5;fontFamily=Courier New;fontSize=28;fontColor=#999999;resizable=0;movable=0;rotatable=0', 100, 100));
